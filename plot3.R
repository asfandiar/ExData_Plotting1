"c:/Users/dell/Desktop/household_power_consumption.txt"
# Read data
data <- read.table("c:/Users/dell/Desktop/household_power_consumption.txt", sep = ";", header = TRUE, stringsAsFactors = FALSE)
# Set date format
